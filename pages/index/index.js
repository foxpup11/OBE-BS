...
this.setData({
    ...
    const zhibiaoshezhi = await list("zhibiaoshezhi",
        {
                    page: 1,
                                                                                                                                                                        }
    ...
    const zhibiaoshezhiresult = zhibiaoshezhi.data?.list?.map(item => {
    item.tupian = baseURL +
        item.tupian.split(",")[0];
    ...
    this.setData({
        homezhibiaoshezhiList:  zhibiaoshezhiresult
    })
