...
for (var o in obj){
    ...
    if(o=='dachengdumubiao'){
    refobjempty["dachengdumubiao"]=obj[o]
        ro.dachengdumubiao = true;
        continue;
    }else{
    }
...
let  objtemp= {
detailList,
                zhishidian: data.zhishidian,
                    dachengdumubiao: data.dachengdumubiao,
    }
...
const obj={
    zhishidian: this.data. zhishidian,
    dachengdumubiao: this.data. dachengdumubiao,
}
const detailId= getApp().globalData.detailId
const tableName= `zhishidian`
...
let corssRes = await list(`zhishidian`, params)
crossoptnum = wx.getStorageSync('statusColumnName');
...
if (ruleForm.id ) {
await update(`zhishidian`, ruleForm)
}
else {
await add(`zhishidian`, ruleForm)
}
}
