...
wx.navigateTo({
url: `/pages/xuesheng/update-and-add?id=${id}`
})
},
async detailBtn(e) {
...
this.setData({
addAuth: utils.isAuth("xuesheng", "新增") || utils.isAuthFront("xuesheng", "新增"),
delAuth: utils.isAuth("xuesheng", "删除") || utils.isAuthFront("xuesheng", "删除"),
editAuth: utils.isAuth("xuesheng", "修改") || utils.isAuthFront("xuesheng", "修改"),
})
