...
this.getData()
 ...
 let obj = {};
//zhuanye筛选
let resInfozhuanye = await option('zhuanye/zhuanye')
    obj["zhuanyeOptions"]= resInfozhuanye.data
this.setData({
    ...obj
})
...
zhuanyeChange(e){
this.setData({
        zhuanye: e.currentTarget.dataset.item
})
},
...
wx.navigateTo({
url: `/pages/kechengxinxi/update-and-add?id=${id}`
})
},
async detailBtn(e) {
...
obj['limit']=this.data.pageSize
    if(this.data.userid){
        resList = await page("kechengxinxi",obj)
    }else{
         resList= await list("kechengxinxi",obj)
    }
