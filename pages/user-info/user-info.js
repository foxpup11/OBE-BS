...
banji.data?.map((item, index) => {
if (item == userInfo.banji) {
this.setData({
banjiIndex: index,
banjiList: banji.data
    ...
    userInfoObj["jiaoshigonghao"]= userInfo.jiaoshigonghao==null?"":userInfo.jiaoshigonghao
    userInfoObj["mima"]= userInfo.mima==null?"":userInfo.mima
    userInfoObj["jiaoshixingming"]= userInfo.jiaoshixingming==null?"":userInfo.jiaoshixingming
userInfo['touxiang']=userInfo?.touxiang?.replace('upload','file')
this.setData({
touxiang:baseURL+userInfo.touxiang,
tempPathtouxiang:baseURL+userInfo.touxiang,
...
banji:this.data.banjiIndex ? this.data.banjiList[this.data.banjiIndex] : "",
